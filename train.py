...
def main():
  ...
  # Set up benchmarks
  benchmarks = [Benchmark('../../../dataset/benchmarks/Set5', name='Set5'),
                Benchmark('../../../dataset/benchmarks/Set14', name='Set14'),
                Benchmark('../../../dataset/benchmarks/BSD100', name='BSD100')]
  ...
  config = tf.ConfigProto(allow_soft_placeement = True, log_device_placement = True)
